...
The final run time is 15ms. Hope it helps!
    ...
    public static void main(String[] args) {
        System.out.println("=== search word II: "+new WordSearchII().findWords(new char[][]{
                {'o','a','a','n'},
  {'e','t','a','e'},
  {'i','h','k','r'},
  {'i','f','l','v'}
    ...
    //Backtracking (dfs) is the powerful way to exhaust every possible ways. Apparently, we need to do pruning when current character is not in any word.
